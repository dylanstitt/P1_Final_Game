def cav_me(num):
    if num == 1:
        ...
        print('\n*SLAM* You hit your head on a stone floor. A CAVE! Find a way out quick and get moving!')
...
def fig_me(num):
    if num == 1:
        print('\nYou have stumbled across one of His disciples. Defeat him and continue on!')
    
    elif num == 2:
        print('\nYou found an enemy! Stop it to continue your journey!')

    else:
        print('\nYou cannot let this beast beat you. You have a goal, defeat him.')
